...
export default function TermsAndConditions(props) {
  return (
    <Grid container spacing={2}>
      ...
      <Grid item xs={8}>
        <Typography variant="h3">Ape Harbour Terms and Conditions</Typography>
        <Typography variant="body1">
          Ape Harbour is a collection of digital artworks (NFTs) running on the
          Ethereum/Polygon network. This website is only an interface allowing
          ...
          Ethereum/Polygon wallets and validating all transactions and contracts
          generated by this website before approval. Furthermore, as the Ape
          Harbour smart contract runs on the Ethereum/Polygon network, there is
        ...
        <Typography variant="body1">
          ...
          Ape Harbour digital collectibles.
        </Typography>

        <Typography variant="h4">1. Ownership</Typography>
        <Typography variant="body1">
          A. You Own the NFT. Each Ape Harbour Yacht is an NFT on the Ethereum
          blockchain. When you purchase an NFT, you own the underlying Ape
          Harbour Yacht, the Art, completely. Ownership of the NFT is mediated
          entirely by the Smart Contract and the Ethereum/Polygon Network: at no
        ...
        <Typography variant="body1">
          ...
          Terms, Laid Back Ventures GmbH grants you a worldwide, royalty-free
          ...
          of a marketplace that permits the purchase and sale of your Ape
          Harbour Yacht / NFT, provided that the marketplace cryptographically
          verifies each Ape Harbour Yacht owner's rights to display the Art for
          their Ape Harbour Yacht to ensure that only the actual owner can
          ...
          of your Ape Harbour Yacht, provided that the website/application
          cryptographically verifies each Ape Harbour Yacht owner's rights to
          display the Art for their Ape Harbour Yacht to ensure that only the
          actual owner can display the Art, and provided that the Art is no
          longer visible once the owner of the Ape Harbour Yacht leaves the
          website/application.
        </Typography>

        <Typography variant="body1">
          C. Commercial Use. Subject to your continued compliance with these
          Terms, Laid Back Ventures GmbH grants you an unlimited, worldwide
          ...
          marketplace that permits the use and sale of Ape Harbour Yachts
          generally, provided that the marketplace cryptographically verifies
          each Ape Harbour Yacht owner's rights to display the Art for their Ape
          Harbour Yacht to ensure that only the actual owner can display the
          Art; (ii) owning or operating a third party website or application
          that permits the inclusion, involvement, or participation of Ape
          Harbour Yachts generally, provided that the third party website or
          application cryptographically verifies each Ape Harbour Yacht owner's
          rights to display the Art for their Ape Harbour Yacht to ensure that
          only the actual owner can display the Art, and provided that the Art
          is no longer visible once the owner of the Purchased Ape Harbour Yacht
          leaves the website/application; or (iii) earning revenue from any of
          the foregoing.
        </Typography>

        <Typography variant="body1">
          D. Laid Back Ventures/Ape Harbour IP. Other than the rights to the
          Art, nothing herein gives you any rights to any other trademarks or
          other intellectual property rights belonging to Laid Back Ventures
          including, without limitation, to Ape Harbour, Laid Back Ventures and
          the associated logos. All of these rights are expressly reserved in
          the name of Laid Back Ventures GmbH.
        </Typography>
        ...
        <Typography variant="h4">2. Your Obligations</Typography>
        <Typography variant="body1">
        ...
        <Typography variant="h4">3. Fees and Payment</Typography>
        <Typography variant="body1">
          A. If you elect to purchase an Ape Harbour Yacht through the Site, any
          financial transactions that you engage in will be conducted solely
          through the Ethereum/Polygon network. We will have no insight into or
          ...
          that you conduct via the Ethereum/Polygon network.
        </Typography>

        <Typography variant="body1">
          B. Ethereum/Polygon requires the payment of a transaction fee (a “Gas
          Fee”) for every transaction that occurs on the Ethereum/Polygon
          network. The Gas Fee funds the network of computers that run the
          decentralized Ethereum/Polygon network. This means that you will need
          to pay a Gas Fee for each transaction.
        </Typography>

        <Typography variant="h4">4. Disclaimers</Typography>
        <Typography variant="body1">
        ...
        <Typography variant="body1">
          ...
          INCUR AS THE RESULT OF YOUR USE OF THE ETHEREUM/POLYGON NETWORK NOR DO
          WE HAVE NO CONTROL OVER AND MAKE NO GUARANTEES REGARDING ANY SMART
          CONTRACTS.
        </Typography>
        ...
        <Typography variant="h4">6. Risk Assumption</Typography>
        <Typography variant="body1">
          You accept and acknowledge each of the following:
        </Typography>

        <Typography variant="body1">
          A. To the extent that you sell your Ape Harbour Yacht NFT, please be
          aware that the prices of NFTs are extremely volatile and fluctuations
          in the prices of other NFTs and impact the price of your Ape Harbour
          Yacht both positively and negatively. Given the volatility, NFTs such
          as Ape Harbour Yacht should not be considered an investment. You
          assume all risks in that connection.
        </Typography>

        <Typography variant="body1">
          B. Ownership of an Ape Harbour Yacht confers ownership of digital
          ...
          financial products. Due to the artistic nature of the project, MAYC
          has not been registered with or approved by any regulator in any
          jurisdiction. It remains your sole responsibility to assure that the
          purchase of the Ape Harbour Yacht and the associated art is in
        ...
        <Typography variant="body1">
          ...
          negatively impact such technologies impacting the value for your Ape
          Harbour Yacht. You understand and accept all risk in that regard.
        </Typography>

        <Typography variant="body1">
          E. You assume all responsibility for any adverse effects of
          disruptions or other issues impacting Ethereum/Polygon or the
          Ethereum/Polygon platform.
        </Typography>

        <Typography variant="h4">7. Indemnification</Typography>
        <Typography variant="body1">
          You agree to hold harmless and indemnify Laid Back Ventures and its
        ...
        <Typography variant="h4">9. Children</Typography>
        <Typography variant="body1">
          Our Site is not intended for children. You must be at least 18 years
          old to access this Site or purchase an Ape Harbour Yacht. If you are
          under 18 years old you are not permitted to use this Site for any
          reason. By accessing the Site, you represent and warrant that you are
        ...
        <Typography variant="body1">
          ...
          finally resolved by arbitration under the rules of of the German Law.
          Each party will cover its own fees and costs associated with the
          arbitration proceedings. The place of arbitration will be Munich,
          Germany. The award of the arbitrator will be final and binding, and
          any judgment on the award rendered by the arbitrator may be entered in
          any court of competent jurisdiction. Notwithstanding the foregoing, we
          may seek and obtain injunctive relief in any jurisdiction in any court
